...
export const INFOGRAPHIC_STYLES: Record<string, InfographicStyle> = {
  notebooklm: {
...
export function getStyleTemplate(styleName: string): InfographicStyle {
  return INFOGRAPHIC_STYLES[styleName] || INFOGRAPHIC_STYLES[DEFAULT_STYLE];
}

export function listAllStyles(): InfographicStyle[] {
